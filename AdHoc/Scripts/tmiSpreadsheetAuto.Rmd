...
today=`date +%Y-%m-%d`
fromfile="/Users/jli/Downloads/bezos$today.csv"
tofile="/Users/jli/Data/AdHoc/Data/TMIBezosSheets/bezos$today.csv"
mv $fromfile $tofile
```
...
library(magrittr)
library(broom)
source('/Users/jli/Data/AdHoc/config/DSUtils.R')
library(data.table)
library(openxlsx)
...
tmi.x <- read_csv(paste0('/Users/jli/Data/AdHoc/Data/TMIBezosSheets/bezos',Sys.Date(),'.csv')) %>%
  tbl_dt() %>%
...
saveWorkbook(
  wb, 
  paste0('/Users/jli/Data/AdHoc/Data/TMIBezosSheets/output_',Sys.Date(),'.xlsx'), 
  overwrite = TRUE
  )
