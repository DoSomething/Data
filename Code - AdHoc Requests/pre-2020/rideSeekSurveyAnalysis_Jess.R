...
surv <-
  read_csv('~/Documents/Ride and Seek/Ride and Seek.csv') %>%
  mutate(
...
save(dat, file = '~/Documents/Ride and Seek/rideSeekSurveyAnalyticalSet.Rdata')

write.csv(dat, file = "rideandseek_final.csv")
