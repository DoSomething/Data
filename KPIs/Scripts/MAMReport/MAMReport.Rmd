...
#### Deeper Dive
* Overall Trend
    * Although there is a substantial decrease month over month it is not very different from last year.
...
```
* Getting back to MAM
    * *Niche new prior 2017-06 is still using old MAM definition*
...
* Activity composition 
    ...
    * Next step is to clean up activity source to add as a pivot
```{r warning=FALSE, echo=FALSE, fig.width=8, fig.height=4}
