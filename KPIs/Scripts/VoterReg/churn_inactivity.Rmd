...
## How many people that DoSomething registered did not opt-in to messaging through the Rock The Vote flow? {.tabset .tabset-pills}
### Overall
* Comment
  - comment 1 
  - comment 2
...
## How many people that DoSomething registered have actively unsubscribed from our messaging? {.tabset .tabset-pills}
### Overall
```{r cache=T, warning=F, message=F, echo=FALSE, fig.height=2.5, fig.width=5}
unsub.ova <-
  tj %>%
...
ttu %>%
  ...
  labs(x='Days to Unsubscribe', y='', color='Subscription Type') +
