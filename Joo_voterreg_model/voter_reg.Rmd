...
saveRDS(final_prediction_data, "Rdata/final_prediction_data.rds")
```
...
```{r}
readRDS("Rdata/final_prediction_data.rds")

# would this have to be customized each time? 
# (example below)
predict(gbm_model, # update based on metric 
        newdata = final_prediction_data,
        n.trees = 150, # must be updated
        type = "response")
```
